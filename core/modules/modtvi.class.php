	...
	public function __construct($db) {
		...
		$this->const = array(
			...
			4 => array(
				...
				'chaine',
				'0',
				"Produit d'assurance responsabilit� civile",
				1,
				'current',
				1
			),
		...
		$this->dictionnaries = array(
				...
				'tabsql' => array(
						'SELECT f.rowid as rowid, f.parc as parc, f.type as type, f.immat as immat, f.chassis as chassis, f.marque as marque, f.active FROM ' . MAIN_DB_PREFIX . 'c_tvi_vehicules as f',
						),
				'tabsqlsort' => array(
						'parc ASC',
				),
				'tabfield' => array(
						"parc,type,immat,chassis,marque",
						),
				'tabfieldvalue' => array(
						"parc,type,immat,chassis,marque",
						),
